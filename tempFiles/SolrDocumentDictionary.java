 ...
 *  </ul>
 */
public class SolrDocumentDictionary implements Dictionary {
   ...
   */
  public SolrDocumentDictionary(SolrIndexSearcher searcher, String field, String weightField) {
   ...
   * for the entry.
   */
  public SolrDocumentDictionary(SolrIndexSearcher searcher, String field, String weightField, String payloadField) {
   ...
   */
  public SolrDocumentDictionary(SolrIndexSearcher searcher, String field, String weightField, String payloadField, String contextsField) {
    ...
    System.out.println("SolrDocumentDictionary constructor is call, payloadField = " + payloadField);
  }
  ...
  protected class DocumentInputIterator implements InputIterator {
    ...
    public DocumentInputIterator(boolean hasPayloads, boolean hasContexts) throws IOException {
      ...
      System.out.println("DocumentInputIterator constructor called, hasPayloads = " + this.hasPayloads);
    }
