...
public class AnalyzingSuggester extends Lookup {
  ...
  public void build(InputIterator iterator) throws IOException {
    System.out.println("AnalyzingSuggester.build() is Called");
    ...
    try {
      ...
      while ((surfaceForm = iterator.next()) != null) {
        ...
        // System.out.print("Paths set size: ");
        ...
        for (IntsRef path : paths) {
          ...
          // System.out.print("surfaceForm length = ");
          // System.out.println(surfaceForm.length);

          BytesRef payload;

          // My additions
          int[] docIdsArray = iterator.docIdsArray();
      ...
      while (reader.read(scratch)) {
        ...
        System.out.println("surface.length = " + surface.length);
